async function run() {
  const url = 'https://firestore.googleapis.com/v1/projects/studio-1424813022-71754/databases/(default)/documents/classes/w3q7qjHhLNs9D8m2a9K0';
  ...
  console.log(`\n--- Class ID: w3q7qjHhLNs9D8m2a9K0 (${name}) ---`);
