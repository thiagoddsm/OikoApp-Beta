...
import { GCFinder } from '@/components/gc/GCFinder';
...
export default function GCPage() {
  ...
  return (
    <div className="bg-surface text-on-surface selection:bg-primary/20 antialiased overflow-x-hidden min-h-screen">
      ...
      {/* ENCONTRE SEU GC (Novo Finder) */}
      <section className="py-24 bg-surface-container/50 relative overflow-hidden border-t border-outline-variant/20" id="encontre-seu-gc">
        <div className="max-w-6xl mx-auto text-center mb-10">
          <span className="uppercase tracking-[0.25em] text-xs font-extrabold text-primary font-body">
            Temos um GC para você
          </span>
          <h2 className="text-3xl sm:text-5xl font-display font-bold text-on-surface mt-4 tracking-tight px-6">
            Encontre a sua <span className="text-primary">Família.</span>
          </h2>
          <p className="text-on-surface-variant text-base mt-4 max-w-2xl mx-auto font-body px-6">
            Não importa sua fase de vida ou onde você mora. Existe um lugar com cadeiras vazias esperando por você.
          </p>
        </div>
